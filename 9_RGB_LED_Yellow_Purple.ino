...
//if it is on we turn on just the Red and Green pins to create a yellow light 
...
//than if any other state but pressed state occurs the RGB LED the Red and BLue turn on 
//while the green stays off to create a purple using the digitalWrite function
else {
digitalWrite(2, 1);
digitalWrite(3, 1);
digitalWrite(4, 0);
